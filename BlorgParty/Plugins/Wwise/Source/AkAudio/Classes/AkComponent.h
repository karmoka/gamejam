...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "AkComponent|Spatial Audio|Geometric Diffraction (Experimental)", meta = (ClampMin = "0"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "AkComponent|Spatial Audio|Geometric Diffraction (Experimental)", meta = (ClampMin = "0.0"))
