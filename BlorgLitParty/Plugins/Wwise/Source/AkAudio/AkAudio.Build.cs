...
public class AkAudio : ModuleRules
{
...
#endif
	{
		...
		if (Target.Platform == UnrealTargetPlatform.Linux || Target.Platform == UnrealTargetPlatform.Switch)
		{
		...
		if (Defs.Contains("AK_OPTIMIZED") == false && Target.Platform != UnrealTargetPlatform.Linux && Target.Platform != UnrealTargetPlatform.Switch)
		{
